...
TSharedPtr< FSlateStyleSet > FBlueprintUncookerStyle::StyleInstance = NULL;
...
TSharedRef< FSlateStyleSet > FBlueprintUncookerStyle::Create()
{
	...
	Style->Set("BlueprintUncooker.OpenPluginWindow", new IMAGE_BRUSH(TEXT("ButtonIcon_40x"), Icon40x40));
